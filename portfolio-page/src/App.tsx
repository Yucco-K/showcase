...
const imageGroups = {
  frontend: [
    { src: '/showcase/screenshots/frontend/frontend-hero-welcome.png', title: 'トップページ', description: '泡アニメーションと魔法の宝珠（Magic Orb）が迎えるウェルカム画面。宝珠は投げたり連打したりして遊べます' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
      ...
      <footer className="bg-gradient-to-r from-purple-900 via-blue-900 to-purple-900 text-white py-12">
        <div className="container mx-auto px-4 text-center space-y-4">
          ...
          <p className="text-purple-200">App Showcase Project - {new Date().getFullYear()}</p>
